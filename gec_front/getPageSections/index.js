...
const pageComponents = [
  ...
  { typeName: "clients", detailPage: GeneralDetailPage, listPage: ClientsListPage }, 
  { typeName: "faq", detailPage: GeneralDetailPage, listPage: FaqListPage }, 
  { typeName: "general_detail", detailPage: GeneralDetailPage, listPage: GeneralListPage }, 
  { typeName: "general_list", detailPage: GeneralDetailPage, listPage: GeneralListPage }, 
  { typeName: "general_detail", detailPage: GeneralDetailPage, listPage: GeneralListPage }, 
  { typeName: "news_and_publications", detailPage: NewsAndPublicationDetailPage, listPage: NewsAndPublicationListPage }, 
  { typeName: "offices", detailPage: GeneralDetailPage, listPage: OfficesListPage }, 
  { typeName: "projects", detailPage: ProjectsDetailPage, listPage: ProjectsListPage },  
  { typeName: "publication", detailPage: PublicationDetailPage, listPage: PublicationListPage }, 
  { typeName: "services", detailPage: ServicesDetailPage, listPage: ServicesListPage }, 
  { typeName: "submenu", detailPage: GeneralDetailPage, listPage: SubmenuListPage }, 
  ...
  { typeName: "vacancies", detailPage: VacanciesDetailPage, listPage: VacanciesListPage },  
